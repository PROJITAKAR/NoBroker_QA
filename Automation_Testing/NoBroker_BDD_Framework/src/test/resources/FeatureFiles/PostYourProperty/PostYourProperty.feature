...
Feature: Post Your Property – Residential Rental on NoBroker
  ...
  Scenario Outline: SC_02 — Submit valid Property Details with different apartment types and BHK configurations
    ...
    And the user loads property detail test data "<TC_ID>" from sheet "<Sheet_ID>"
    When the user selects Apartment Type and BHK from test data
    And the user selects Floor and Property Age from test data
    And the user selects Facing and enters Built-up Area from test data
    ...
    Examples:
      | TC_ID | Sheet_ID        |
      | TC01  | PropertyDetails |
      | TC02  | PropertyDetails |
  ...
  Scenario Outline: SC_03 — Successfully submit Rental Details with valid rent and deposit values
    ...
    And the user loads rental test data "<TC_ID>" from sheet "<Sheet_ID>"
  ...
  Scenario Outline: SC_04 — Upload valid photos and videos in different formats and verify preview thumbnails
    ...
    And the user loads photo upload test data "<TC_ID>" from sheet "<Sheet_ID>"
  ...
  Scenario: SC_07 — End-to-End: Complete full property posting journey and verify success
    ...
    And the user selects "3" as Floor and "5 to 10 year" as Property Age
    ...
    When the user selects Pune as City and "Pune" as Locality
    ...
    Then a success message should be displayed: "Congratulations!"
